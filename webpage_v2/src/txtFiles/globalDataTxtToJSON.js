...
const readQuarter = (currentQuarterLocal) => {
    ...
    return (currentQuarterLocal === 1)
            ? readFileSync("regional_data/wii_u_fy3_2014/firstQuarter.txt", "utf-8")
            : (currentQuarterLocal === 2)
            ? readFileSync("regional_data/wii_u_fy3_2014/secondQuarter.txt", "utf-8") 
            : (currentQuarterLocal === 3)
            ? readFileSync("regional_data/wii_u_fy3_2014/thirdQuarter.txt", "utf-8")
            : readFileSync("regional_data/wii_u_fy3_2014/fourthQuarter.txt", "utf-8");
};
