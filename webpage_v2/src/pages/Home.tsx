        ...
        <div>
            ...
            <Stack align="center">
                ...
                <List listStyleType="disc">
                    ...
                    <Text>Capcom -</Text>
                    <List withPadding listStyleType="disc">
                        <List.Item>Latest update: Platinum Titles list FY3/2023 updated.</List.Item>
                        <List.Item>Future update planned: Notes section.</List.Item>
                    </List>
                    ...
                    <List withPadding listStyleType="disc">
                        <List.Item>Latest update: FY Series IP data and Sales per Software Unit data from FY3/2021 to FY3/2022 added.</List.Item>
                    </List>
                    <Text>Events -</Text>
                    <List withPadding listStyleType="disc">
