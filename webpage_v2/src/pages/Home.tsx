...
const Home = () => {
    ...
    const eventsStatus = liner(printTextBlock("Events page status",32),"=","top",true,32) + liner(printTextBlock("Page update: Updated calendar for 11 of 22 companies from April to May 2023.",40),"−","both",true,40);
