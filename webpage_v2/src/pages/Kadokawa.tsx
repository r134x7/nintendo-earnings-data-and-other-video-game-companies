...
import KADOKAWA_COMPONENT from "../components/KADOKAWA_COMPONENT";
import KADOKAWA_CML from "../components/special/KADOKAWA_CML";
import type { BackgroundColours } from "../features/backgroundReducer";

import { liner, printTextBlock, useSingleMessage } from "../utils/table_design_logic";

const currentYear = 2025;
const yearRange = currentYear - 2015;
...
export default function KoeiTecmo() {
    ...
    const message = `Kadokawa (They own FromSoftware), this is where you can find archived data.`;
    ...
    (yearUsed: string): JSX.Element | null => {
        ...
        return (yearIndexed >= 0) ? <KADOKAWA_COMPONENT setIndex={yearIndexed} yearLength={yearsLength} /> : null
    };
