...
import CYBERAGENT_COMPONENT from "../components/CYBERAGENT_COMPONENT";
import CYBERAGENT_CML from "../components/special/CYBERAGENT_CML";
...
export default function KoeiTecmo() {
    ...
    const message = `CyberAgent (They own Cygames), this is where you can find archived data.`;
    ...
    (yearUsed: string): JSX.Element | null => {
        ...
        return (yearIndexed >= 0) ? <CYBERAGENT_COMPONENT setIndex={yearIndexed} yearLength={yearsLength} /> : null
    };
