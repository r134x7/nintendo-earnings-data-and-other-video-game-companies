...
import { printSeriesFY } from "../../data/capcom/Capcom_FY3_2020/game_series_sales_fy3_2020"
import { printSoftwareShipments } from "../../data/capcom/Capcom_FY3_2020/software_shipments_platform_fy3_2020";

export default function CAPCOM_FY3_2020() {
            ...
            <Text>
                <Stack align="center">
                    ...
                    <Anchor mb="sm" href="https://www.capcom.co.jp/ir/english/business/salesdata.html" target="_blank" >
                        ...
                        Capcom Fact Book 2020:
                    <Anchor mb="sm" href="https://www.capcom.co.jp/ir/english/data/pdf/annual/2020/annual_2020_09.pdf" target="_blank" >
                        https://www.capcom.co.jp/ir/english/data/pdf/annual/2020/annual_2020_09.pdf
                    </Anchor>
                </Stack>  
            </Text> 
        )
