...
export default function EVENTS_CALENDAR() {
    ...
    const dateArray: EventDate[] = [
        ...
        },
        {
            ...
            eventName: dateTemplate("2nd", 6, "June", currentYear),
            eventDate: "January 29, 2025",
        ...
        },
        {
            id: 10,
            companyName: "GungHo",
            eventName: dateTemplate("4th", 12, "December", currentYear),
        ...
        },
        {
            id: 17,
            companyName: "GREE",
            eventName: dateTemplate("2nd", 6, "June", nextYear),
            eventDate: "February 6, 2025",
            timeZone: "Japan, JST, UTC +9 Hours",
