...
export default function EVENTS_CALENDAR() {
    ...
    const dateArray: EventDate[] = [
        ...
        },
        {
            id: 20,
            companyName: "Falcom",
            eventName: dateTemplate("3rd", 9, "September", nextYear),
            eventDate: "August 9, 2024",
            timeZone: "Japan, JST, UTC +9 Hours",
