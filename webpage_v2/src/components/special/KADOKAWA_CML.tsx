...
import { cumulativeSegmentListKadokawa } from "../../data/generalTables/segment_earnings_general_cml_data";
import { cumulativeEarningsListKadokawa } from "../../data/generalTables/consolidated_earnings_cml_data";
import type { BackgroundColours } from "../../features/backgroundReducer";

import {cite, citeCopy} from "../../utils/copySetCitation";

export default function KADOKAWA_CML() {
    ...
    useEffect(() => {
        ...
        switch (value) {
            case "Kadokawa Consolidated Operating Results - Cumulative":
            ...
            case "Kadokawa Segment Information - Cumulative":
                if (timePeriodValue === "1st Quarter") {
                    setTimePeriod(0)
                } else if (timePeriodValue === "2nd Quarter") {
                    setTimePeriod(1)
    ...
    const componentList = [
        {
            name: "Kadokawa Consolidated Operating Results - Cumulative",
            value: cumulativeEarningsListKadokawa[timePeriod]
        },
        {
            name: "Kadokawa Segment Information - Cumulative",
            value: cumulativeSegmentListKadokawa[timePeriod]
        },
    ];
    ...
    return (
        ...
        <div>  
            ...
            <Code onCopy={e => citeCopy(e, cite)} style={{backgroundColor:`${stateColour}`, color:(stateFontColor === "dark") ? "#fff" : "#000000"}} block>
                {(value === "Kadokawa Consolidated Operating Results - Cumulative" || value === "Kadokawa Segment Information - Cumulative")
                    ? <Select
                        data={[
                         "1st Quarter",
                         "2nd Quarter",
