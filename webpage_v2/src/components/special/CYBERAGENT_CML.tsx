...
import { cumulativeSegmentListCyberAgent } from "../../data/generalTables/segment_earnings_general_cml_data";
import { cumulativeEarningsListCyberAgent } from "../../data/generalTables/consolidated_earnings_cml_data";
import type { BackgroundColours } from "../../features/backgroundReducer";

import {cite, citeCopy} from "../../utils/copySetCitation";

export default function CYBERAGENT_CML() {
    ...
    useEffect(() => {
        ...
        switch (value) {
            case "CyberAgent Consolidated Operating Results - Cumulative":
            ...
            case "CyberAgent Segment Information - Cumulative":
                if (timePeriodValue === "1st Quarter") {
                    setTimePeriod(0)
                } else if (timePeriodValue === "2nd Quarter") {
                    setTimePeriod(1)
    ...
    const componentList = [
        {
            name: "CyberAgent Consolidated Operating Results - Cumulative",
            value: cumulativeEarningsListCyberAgent[timePeriod]
        },
        {
            name: "CyberAgent Segment Information - Cumulative",
            value: cumulativeSegmentListCyberAgent[timePeriod]
        },
    ];
    ...
    return (
        ...
        <div>  
            ...
            <Code onCopy={e => citeCopy(e, cite)} style={{backgroundColor:`${stateColour}`, color:(stateFontColor === "dark") ? "#fff" : "#000000"}} block>
                {(value === "CyberAgent Consolidated Operating Results - Cumulative" || value === "CyberAgent Segment Information - Cumulative")
                    ? <Select
                        data={[
                         "1st Quarter",
                         "2nd Quarter",
