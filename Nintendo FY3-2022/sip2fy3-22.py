...
rw1 = [ " 1st Quarter (Units)      ", " 2nd Quarter (Units)      " ,  " 3rd Quarter (Units)      ",   " 4th Quarter (Units)      ", " FY3/22 Cumulative (Units)", " 1st Quarter WW%          ", " 2nd Quarter WW%          ", " 3rd Quarter WW%          ", " 4th Quarter WW%          ", " FY3/22 Cumulative WW%    ", " Life-To-Date (Units)     ", " Life-To-Date WW%         " ] # row names
lb1 = "###" # line break

#print(len(hd1[3]))

#Remember to update all numbers before next results
