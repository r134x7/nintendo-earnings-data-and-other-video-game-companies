...
def operating_margin (a, b): # a = net_sales_1, b = operating_income_1
...
operating_margin_1 = operating_margin(net_sales_1, operating_income_1)
...
def print_mobile():
    ...
    for i in range(0, 8, 2):
        ...
        if current_quarter >= 4: # fy cumulative
