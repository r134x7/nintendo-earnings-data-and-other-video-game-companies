...
export const printFYMillionSellerTitles = (currentQuarter === 1 || currentQuarter === 2 || currentQuarter === 3) // can't use !== 4 for one condition only or else it assumes condition is always true
